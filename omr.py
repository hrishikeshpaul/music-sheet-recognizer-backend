...
import sys
import os
from TemplateDetection import rescale_template, template_match, temp_position
from NoteDetection import specify_notes
from HoughSpace import EdgeDetection, get_staff_and_spacing_parameter
import pandas as pd
